...
class SoletypeAction extends CommonAction {
	...
	public function checkData($strPost,$dataType){
		...
		$strData['sole_title'] =htmlspecialchars($strPost['sole_title']);
		$strData['keywords'] =htmlspecialchars($strPost['keywords']);
		$strData['description'] =htmlspecialchars($strPost['description']);
