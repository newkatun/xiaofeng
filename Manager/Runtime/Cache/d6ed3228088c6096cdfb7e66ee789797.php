...
<script language="javascript" type="text/javascript" src="<?php echo ($WEBNAME); ?>/Public/js/common.js"></script>
 ...
 <body>
<form name="formadd" method="post" action="__APP__/Userlist/saveadd" id="formadd">
...
<td height="40" colspan="4" align="left" background="images/nzcms_top01.gif" bgcolor="#C9DEFA" class="nzcms_table_top"><a href="__APP__/Userlist/index">网站管理员列表</a>>>增加网站管理员</td>
</tr>
<tr bgcolor="#FFFFFF" onmouseout="this.bgColor='#FFFFFF';" onmouseover="this.bgColor='#E4EDF9';">
<td width="12%" align="center">管理员帐号：</td>
<td>&nbsp;<input type="text" value="" class="inputtext" id="user_name" name="user_name" size="40"></td>
</tr>
<tr bgcolor="#FFFFFF" onmouseout="this.bgColor='#FFFFFF';" onmouseover="this.bgColor='#E4EDF9';">
...
<td>&nbsp;<input type="text" value="" class="inputtext" id="user_email" name="user_email" size="40"></td>   
</tr>
<tr bgcolor="#FFFFFF" onmouseout="this.bgColor='#FFFFFF';" onmouseover="this.bgColor='#E4EDF9';">
<td align="center">管理员权限：</td>
<td>&nbsp;<input type="checkbox"  value="1" class="inputtext" id="user_power" name="user_power[]">产品管理 &nbsp;&nbsp;<input type="checkbox"  value="4" class="inputtext" id="user_power" name="user_power[]">订单管理&nbsp;<input type="checkbox"  value="2" class="inputtext" id="user_power" name="user_power[]">用户管理&nbsp;<input type="checkbox"  value="5" class="inputtext" id="user_power" name="user_power[]">文章管理&nbsp;<input type="checkbox"  value="3" class="inputtext" id="user_power" name="user_power[]">功能管理&nbsp;</td>   
</tr>
<tr bgcolor="#FFFFFF" onmouseout="this.bgColor='#FFFFFF';" onmouseover="this.bgColor='#E4EDF9';">
<td align="center">管理员备注：</td>
<td>&nbsp;<textarea class="inputtextarea" id="user_intro" name="user_intro" cols="70" rows="4"></textarea></td>
</tr>
<tr onMouseOver="this.bgColor='#E4EDF9';" onMouseOut="this.bgColor='#FFFFFF';" bgcolor="#ffffff">
<td  align="right">&nbsp;</td>
