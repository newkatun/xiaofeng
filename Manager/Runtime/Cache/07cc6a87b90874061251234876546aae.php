...
<tr> <td    class="nzcms_table_top" >视频列表<span class="table_spanadd"><a href="__APP__/Videolist/addtable">增加视频</a></span></td></tr>
<tr valign="top">
<td  bgcolor="#FFFFFF">
...
<td  style="padding-left:8px;">
 ...
 <td align="left" valign="top" bgcolor="#FFFFFF" class="z">
  ...
  <form action="__APP__/Videolist/dellist" method="post" name="formlist" id="formlist">
  <tr align="center" bgcolor="#00739e">
  <td width="5%" class="nzcms_table_top2">选择</td>
  <td width="35%" class="nzcms_table_top2">视频名称</td>
  <td width="25%" class="nzcms_table_top2">视频标签 </td>
  <td width="10%" class="nzcms_table_top2">视频存放</td>
  <td width="15%" class="nzcms_table_top2">发布时间</td>
  <td width="10%" class="nzcms_table_top2">修改</td>
  </tr>
	<?php if(is_array($VideoList) == true): if(is_array($VideoList)): $i = 0; $__LIST__ = $VideoList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$Video): $mod = ($i % 2 );++$i;?><tr onMouseOver="this.bgColor='#E4EDF9';" onMouseOut="this.bgColor='#FFFFFF';" bgcolor="#ffffff">
	<td height='30' align='center'><input name='id[]' type='checkbox' id='id' value='<?php echo ($Video["autoid"]); ?>' onClick='javascript:changecolor(this.name);'  /></td>
	<td >&nbsp;<?php echo ($Video["v_title"]); ?></td>
	<td>&nbsp;<?php echo ($Video["v_prodcode"]); ?></td>
	<td align="center">&nbsp;<font color='green'><?php echo ($Video["v_videosource"]); ?></font></td>
	<td align='center'><?php echo ($Video["v_datetime"]); ?></td>
	<td align='center'><a href="__APP__/Videolist/edittable/id/<?php echo ($Video["autoid"]); ?>">修改</a></td>
