...
<tr> <td    class="nzcms_table_top" >注册会员列表</td></tr>
<tr valign="top">
<td  bgcolor="#FFFFFF">
...
<td  style="padding-left:8px;">
 ...
 <td align="left" valign="top" bgcolor="#FFFFFF" class="z">
  ...
  <form action="__APP__/Memberlist/dellist" method="post" name="formlist" id="formlist">
  <tr bgcolor="#C9DEFA" align="center">
  <td width="5%" class="nzcms_table_top2">选择</td>
  <td width="12%" class="nzcms_table_top2">帐号名称 </td>
  <td class="nzcms_table_top2">电子邮箱</td>
  <td width="15%" class="nzcms_table_top2">登录次数</td>
  <td width="15%" class="nzcms_table_top2">注册时间</td>
  <td width="15%" class="nzcms_table_top2">帐号状态</td>
  <td width="10%" class="nzcms_table_top2">查看</td>
  </tr>
	<?php if(is_array($MemberList) == true): if(is_array($MemberList)): $i = 0; $__LIST__ = $MemberList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$Member): $mod = ($i % 2 );++$i;?><tr onMouseOver="this.bgColor='#E4EDF9';" onMouseOut="this.bgColor='#FFFFFF';" bgcolor="#ffffff">
	<td height='30' align='center'><input name='id[]' type='checkbox' id='id' value='<?php echo ($Member["autoid"]); ?>' onClick='javascript:changecolor(this.name);'  /></td>
	<td >&nbsp;<?php echo ($Member["mem_name"]); ?></td>
	<td>&nbsp;<?php echo ($Member["mem_email"]); ?></td>
	<td>&nbsp;<?php echo ($Member["mem_logtime"]); ?></td>
	<td>&nbsp;<?php echo ($Member["mem_regtime"]); ?></td>
	<td align='center'><?php echo ($Member["mem_status"]); ?></td>
	<td align='center'><a href="__APP__/Memberlist/edittable/id/<?php echo ($Member["autoid"]); ?>">查看</a></td>
	</tr><?php endforeach; endif; else: echo "" ;endif; ?>
	<?php else: ?>
	<tr onMouseOver="this.bgColor='#E4EDF9';" onMouseOut="this.bgColor='#FFFFFF';"  bgcolor="#FFFFFF">
	<td colspan="7" align="center" height="30">没有找到相关内容！</td>
	</tr><?php endif; ?>
 <tr onMouseOver="this.bgColor='#E4EDF9';" onMouseOut="this.bgColor='#FFFFFF';"  bgcolor="#FFFFFF">
