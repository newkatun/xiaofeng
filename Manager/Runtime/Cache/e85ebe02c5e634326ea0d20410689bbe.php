...
<script language="javascript" type="text/javascript" src="<?php echo ($WEBNAME); ?>/Public/js/kindeditor.js"></script>
 ...
 <body>
<form name="formadd" method="post" action="__APP__/Productlist/saveadd" id="formadd">
...
<td height="40" colspan="4" align="left" background="images/nzcms_top01.gif" bgcolor="#C9DEFA" class="nzcms_table_top"><a href="__APP__/Productlist/index">产品列表</a>>>修改产品</td>
 ...
 <tr >
  ...
  <td  align="left" width="40%"><input name="p_id" class="inputtext" type="text" id="p_id" size="40" value="" ><font color="red"><span id="p_idspan"></span></font></td>
  <td width="10%"  align="right" ><strong>产品名称：</strong></td>
  <td  align="left" width="40%"><input name="p_name" class="inputtext" type="text" id="p_name" size="40" value=""><font color="red"><span id="p_namespan"></span></font></td>
</tr>
<tr > 
...
<tr >
  ...
  <td  align="left" ><input name="p_img" class="inputtext" type="text" id="p_img" size="40" value="">&nbsp;&nbsp;&nbsp;<input name="button" type="button" class="uploadimg"  attrimage="p_img" value="上传图片" /><font color="red"><span id="p_imgspan"></span></font></td>
 <td width="10%"  align="right" ><strong>产品排序：</strong></td>
  <td  align="left" ><input name="p_sort" class="inputtext" type="text" id="p_sort" size="5" value="0" onKeyUp="this.value=this.value.replace(/[^\d]/g,'')" onbeforepaste="clipboardData.setData('text',clipboardData.getData('text').replace(/[^\d]/g,''))"><font color="red">网站前台显示从大到小排列</font></td>
</tr>
 <tr >
  <td width="10%"  align="right" ><strong>产品价格：</strong></td>
  <td  align="left" width="40%"><input name="p_price" class="inputtext" type="text" id="p_price" size="40" value="" ><font color="red"><span id="p_idspan"></span></font></td>
  <td width="10%"  align="right" ><strong>产品市场价：</strong></td>
  <td  align="left" width="40%"><input name="p_oldprice" class="inputtext" type="text" id="p_oldprice" size="40" value=""><font color="red"><span id="p_namespan"></span></font></td>
</tr>
<tr >
 <td  align="right"  ><strong>产品关键词：</strong></td>
 <td  align="left" colspan="3"><input name="p_keywords" type="text" id="p_keywords" class="inputtext" size="60" value=""/>&nbsp;&nbsp;&nbsp;</td>
 </tr>
 <tr >
 <td  align="right"  ><strong>产品描述：</strong></td>
 <td  align="left" colspan="3"><textarea name="p_description" cols="60" rows="3" class="textarea"></textarea></td>
 </tr>
<tr >
 <td width="10%"  align="right" ><strong>产品简介：</strong></td>
  <td  align="left" colspan="3"><textarea name="p_intro" class="textarea" type="text" id="p_intro" cols="80" rows="3" ></textarea><span id="P_introspan"></span></td> 
</tr>
<tr >
...
<tr >
  ...
  <td  align="left" colspan="3">&nbsp;<input type="radio" value="1" name="p_new" >是&nbsp;&nbsp;<input type="radio" value="0" name="p_new" checked="checked">否</td>
  </tr> 
