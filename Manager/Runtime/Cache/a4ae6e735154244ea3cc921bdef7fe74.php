...
<tr> <td    class="nzcms_table_top" >网站页面列表<span class="table_spanadd"><a href="__APP__/Pagelist/addtable">增加网站页面</a></span></td></tr>
<tr valign="top">
<td  bgcolor="#FFFFFF">
...
<td  style="padding-left:8px;">
 ...
 <td align="left" valign="top" bgcolor="#FFFFFF" class="z">
  ...
  <form action="__APP__/Pagelist/dellist" method="post" name="formlist" id="formlist">
  <tr bgcolor="#C9DEFA" align="center">
  <td width="5%" class="nzcms_table_top2">选择</td>
  <td width="15%" class="nzcms_table_top2">页面名称 </td>
  <td width="20%" class="nzcms_table_top2">页面标题</td>
  <td width="35%" class="nzcms_table_top2">页面关键字</td>
  <td width="15%" class="nzcms_table_top2">添加时间</td>
  <td width="10%" class="nzcms_table_top2">修改</td>
  </tr>
	<?php if(is_array($PageList) == true): if(is_array($PageList)): $i = 0; $__LIST__ = $PageList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$Page): $mod = ($i % 2 );++$i;?><tr onMouseOver="this.bgColor='#E4EDF9';" onMouseOut="this.bgColor='#FFFFFF';" bgcolor="#ffffff">
	<td height='30' align='center'><input name='id[]' type='checkbox' id='id' value='<?php echo ($Page["autoid"]); ?>' onClick='javascript:changecolor(this.name);'  /></td>
	<td >&nbsp;<?php echo ($Page["c_name"]); ?></td>
	<td>&nbsp;<?php echo ($Page["c_title"]); ?></td>
	<td>&nbsp;<?php echo ($Page["c_keywords"]); ?></td>
	<td align='center'><?php echo ($Page["c_datetime"]); ?></td>
	<td align='center'><a href="__APP__/Pagelist/edittable/id/<?php echo ($Page["autoid"]); ?>">修改</a></td>
