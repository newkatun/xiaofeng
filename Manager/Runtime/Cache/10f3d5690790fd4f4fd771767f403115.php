...
<script  type="text/javascript" src="<?php echo ($WEBNAME); ?>/Public/js/uploadimg.js"></script>
 ...
 <body>
<form name="formadd" method="post" action="__APP__/Paymentlist/saveedit" id="formadd">
...
<td>&nbsp;<input type="text" size="60" name="pay_name" id="pay_name" class="inputtext" value="<?php echo ($Payment["pay_name"]); ?>" /></td>   
</tr>
<tr onMouseOver="this.bgColor='#E4EDF9';" onMouseOut="this.bgColor='#FFFFFF';" bgcolor="#ffffff">
<td align="center">支付网关：</td>
<td >&nbsp;<input type="text" name="pay_weburl" id="pay_weburl" size="60" value="<?php echo ($Payment["pay_weburl"]); ?>">&nbsp;</td>
</tr>
<tr onMouseOver="this.bgColor='#E4EDF9';" onMouseOut="this.bgColor='#FFFFFF';" bgcolor="#ffffff">
<td align="center">支付帐号：</td>
<td >&nbsp;<input type="text" name="pay_code" id="pay_code" size="60" value="<?php echo ($Payment["pay_code"]); ?>">&nbsp;</td>
</tr>
<tr onMouseOver="this.bgColor='#E4EDF9';" onMouseOut="this.bgColor='#FFFFFF';" bgcolor="#ffffff">
<td align="center">支付方式状态：</td>
<td >&nbsp;<input type="radio" name="pay_status" id="pay_status" value="1" <?php echo (htmlcheck($Payment["pay_status"],1)); ?>>开启&nbsp;<input type="radio" name="pay_status" id="pay_status" value="0" <?php echo (htmlcheck($Payment["pay_status"],0)); ?>>关闭</td>
</tr>

<tr onMouseOver="this.bgColor='#E4EDF9';" onMouseOut="this.bgColor='#FFFFFF';" bgcolor="#ffffff">
<td align="center">支付方式LOGO：</td>
<td >&nbsp;<input type="text" name="pay_logo" id="pay_logo" size="60" value="<?php echo ($Payment["pay_logo"]); ?>">&nbsp;<input type="button" class="uploadimg" value="上传图片" attrname="pay_logo"></td>
</tr>
<tr onMouseOver="this.bgColor='#E4EDF9';" onMouseOut="this.bgColor='#FFFFFF';" bgcolor="#ffffff">
<td align="center">提示信息：</td>
<td>&nbsp;<Textarea rows="3" cols="80" name="pay_message" id="pay_message"><?php echo ($Payment["pay_message"]); ?></textarea></td>
</tr>
<tr onMouseOver="this.bgColor='#E4EDF9';" onMouseOut="this.bgColor='#FFFFFF';" bgcolor="#ffffff">
<td align="center">支付方式说明：</td>
<td>&nbsp;<Textarea rows="3" cols="80" name="pay_intro" id="pay_intro"><?php echo ($Payment["pay_intro"]); ?></textarea></td>
</tr>
<tr onMouseOver="this.bgColor='#E4EDF9';" onMouseOut="this.bgColor='#FFFFFF';" bgcolor="#ffffff">
<td  align="right">&nbsp;</td>
<td colspan="3"><input type="hidden" value="<?php echo ($Payment["autoid"]); ?>" id="autoid" name="autoid">
