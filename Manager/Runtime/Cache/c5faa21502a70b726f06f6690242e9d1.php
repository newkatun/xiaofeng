...
<tr> <td    class="nzcms_table_top" >国家名称列表<span class="table_spanadd"><a href="__APP__/Countrylist/addtable">增加国家名称</a></span></td></tr>
<tr valign="top">
<td  bgcolor="#FFFFFF">
...
<td  style="padding-left:8px;">
 ...
 <td align="left" valign="top" bgcolor="#FFFFFF" class="z">
  ...
  <form action="__APP__/Countrylist/dellist" method="post" name="formlist" id="formlist">
  <tr align="center" bgcolor="#00739e">
  <td width="5%" class="nzcms_table_top2">选择</td>
  <td width="20%" class="nzcms_table_top2">国家名称</td>
  <td width="40%" class="nzcms_table_top2">国家编号</td>
    <td width="10%" class="nzcms_table_top2">首重运费</td>
  <td width="10%" class="nzcms_table_top2">修改</td>
  </tr>
	<?php if(is_array($CountryList) == true): if(is_array($CountryList)): $i = 0; $__LIST__ = $CountryList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$Country): $mod = ($i % 2 );++$i;?><tr onMouseOver="this.bgColor='#E4EDF9';" onMouseOut="this.bgColor='#FFFFFF';" bgcolor="#ffffff">
	<td height='30' align='center'><input name='id[]' type='checkbox' id='id' value='<?php echo ($Country["autoid"]); ?>' onClick='javascript:changecolor(this.name);'  /></td>
	<td >&nbsp;<?php echo ($Country["country_name"]); ?></td>
	<td>&nbsp;<?php echo ($Country["country_code"]); ?></td>
	<td>&nbsp;<?php echo ($Country["country_shipping"]); ?></td>
	<td align='center'><a href="__APP__/Countrylist/edittable/id/<?php echo ($Country["autoid"]); ?>">修改</a></td>
 ...
 <tr onMouseOver="this.bgColor='#E4EDF9';" onMouseOut="this.bgColor='#FFFFFF';"  bgcolor="#FFFFFF">
 <td height="30" colspan="3">&nbsp;&nbsp; <input name="button" type="button" class="button" onClick="selectAll(document.formlist)" value="全选本页数据" />
