...
<tr> <td    class="nzcms_table_top" >产品列表<span class="table_spanadd"><a href="__APP__/Categorylist/addtable">增加产品</a></span></td></tr>
<tr valign="top">
<td  bgcolor="#FFFFFF">
<table width="100%" border="1" cellpadding="0" cellspacing="1" bordercolor="#FFFFFF" bgcolor="#abd9fc"  class="table" align="center">
<tr class="search">
<td  style="padding-left:8px;">
<form name="formselect" method="get" action="?action=select" id="formselect">

 
<strong>产品细类：</strong> 
&nbsp;<Select name="p_ttypeid" id="p_ttypeid">
<option value="0">Please Select</option>
</select>
<input type="hidden" value="select" name="action"><input type="submit" value="submit" />
</form >
</td>
 ...
 <td align="left" valign="top" bgcolor="#FFFFFF" class="z">
  ...
  <form action="__APP__/Categorylist/dellist" method="post" name="formlist" id="formlist">
  <tr align="center" bgcolor="#00739e">
  <td width="5%" class="nzcms_table_top2">选择</td>
  <td width="25%" class="nzcms_table_top2">类型名称</td>
  <td  class="nzcms_table_top2">类型图片</td>
  <td width="10%" class="nzcms_table_top2">类型排序</td>
  <td width="20%" class="nzcms_table_top2">查看|修改</td>
  </tr>
  <?php if(is_array($CategoryList)): $i = 0; $__LIST__ = $CategoryList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$Cate): $mod = ($i % 2 );++$i;?><tr onMouseOver="this.bgColor='#E4EDF9';" onMouseOut="this.bgColor='#FFFFFF';" bgcolor="#ffffff">
<td height='30' align='center'><input name='id[]' type='checkbox' id='id' value='<?php echo ($Cate["autoid"]); ?>' onClick='javascript:changecolor(this.name);'  /></td>
<td >&nbsp;<a href="__APP__/Productlist/index/mid/<?php echo ($Cate["autoid"]); ?>"><?php echo ($Cate["ty_name"]); ?></td>
<td>&nbsp;<?php echo ($Cate["ty_imgurl"]); ?></td>
<td align='center'><?php echo ($Cate["ty_sort"]); ?></td>
<td align='center'><a href="__APP__/Productlist/index/mid/<?php echo ($Cate["autoid"]); ?>">查看产品</a>&nbsp;|&nbsp;<a href="__APP__/Categorylist/submenu/id/<?php echo ($Cate["autoid"]); ?>">查看子目录</a>&nbsp;|&nbsp;<a href="__APP__/Categorylist/edittable/id/<?php echo ($Cate["autoid"]); ?>">修改</a></td>
