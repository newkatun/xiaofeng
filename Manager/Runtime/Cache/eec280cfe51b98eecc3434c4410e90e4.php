...
<script language="javascript" type="text/javascript" src="<?php echo ($WEBNAME); ?>/Public/js/kindeditor.js"></script>
 ...
 <body>
<form name="formadd" method="post" action="__APP__/Pagelist/saveedit" id="formadd">
...
<td>&nbsp;<input type="text" value="<?php echo ($Page["c_name"]); ?>" class="inputtext" id="c_name" name="c_name" size="40"></td>
</tr>
<tr bgcolor="#FFFFFF" onmouseout="this.bgColor='#FFFFFF';" onmouseover="this.bgColor='#E4EDF9';">
<td align="center">页面标题：</td>
<td>&nbsp;<input type="text" value="<?php echo ($Page["c_title"]); ?>" class="inputtext" id="c_title" name="c_title" size="40"></td>
</tr>
<tr bgcolor="#FFFFFF" onmouseout="this.bgColor='#FFFFFF';" onmouseover="this.bgColor='#E4EDF9';">
<td align="center">页面关键字：</td>
<td>&nbsp;<input type="text" value="<?php echo ($Page["c_keywords"]); ?>" class="inputtext" id="c_keywords" name="c_keywords" size="40"></td>
</tr>
<tr bgcolor="#FFFFFF" onmouseout="this.bgColor='#FFFFFF';" onmouseover="this.bgColor='#E4EDF9';">
<td align="center">页面描述：</td>
<td>&nbsp;<textarea class="inputtextarea" id="c_description" name="c_description" cols="70" rows="4"><?php echo ($Page["c_description"]); ?></textarea></td>   
</tr>

<tr bgcolor="#FFFFFF" onmouseout="this.bgColor='#FFFFFF';" onmouseover="this.bgColor='#E4EDF9';">
<td align="center">详细内容：</td>
<td><textarea class="inputtextarea" id="p_content" name="p_content" cols="70" rows="4" style="width:98%;"><?php echo ($Page["c_introduction"]); ?></textarea></td>
</tr>
<tr onMouseOver="this.bgColor='#E4EDF9';" onMouseOut="this.bgColor='#FFFFFF';" bgcolor="#ffffff">
<td  align="right">&nbsp;</td>
<td colspan="3"><input type="hidden" value="<?php echo ($Page["autoid"]); ?>" id="autoid" name="autoid">
