...
<tr> <td    class="nzcms_table_top" ><a href="__APP__/Categorylist/index">产品类型列表</a>&gt;&gt;<?php echo ($CateMain["ty_name"]); ?><span class="table_spanadd"><a href="__APP__/Categorylist/addtable">增加产品类型</a></span></td></tr>
<tr valign="top">
<td  bgcolor="#FFFFFF">
...
<td  style="padding-left:8px;">
 ...
 <td align="left" valign="top" bgcolor="#FFFFFF" class="z">
  ...
  <td width="20%" class="nzcms_table_top2">类型名称</td>
  <td  class="nzcms_table_top2">类型图片</td>
  <td width="10%" class="nzcms_table_top2">类型排序</td>
  <td width="10%" class="nzcms_table_top2">查看|修改</td>
  </tr>
 <?php if(is_array($CategoryList) == true): if(is_array($CategoryList)): $i = 0; $__LIST__ = $CategoryList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$Cate): $mod = ($i % 2 );++$i;?><tr onMouseOver="this.bgColor='#E4EDF9';" onMouseOut="this.bgColor='#FFFFFF';" bgcolor="#ffffff">
...
<td align='center'><a href="__APP__/Productlist/index/sid/<?php echo ($Cate["autoid"]); ?>">查看产品</a>&nbsp;|&nbsp;<a href="__APP__/Categorylist/edittable/id/<?php echo ($Cate["autoid"]); ?>">修改</a></td>
