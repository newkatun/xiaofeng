...
<script language="javascript" type="text/javascript" src="<?php echo ($WEBNAME); ?>/Public/js/uploadimg.js"></script>
 ...
 <body>
<form name="formadd" method="post" action="__APP__/Sliderlist/saveadd" id="formadd">
...
<td  align="left" colspan="3">&nbsp;<input name="sl_title" class="inputtext" type="text" id="sl_title" size="60" value=""><font color="red"><span id="fr_namespan"></span></font></td>
</tr>
<tr onMouseOver="this.bgColor='#E4EDF9';" onMouseOut="this.bgColor='#FFFFFF';" bgcolor="#ffffff">
<td width="10%"  align="right" ><strong>广告标签:</strong> </td>
<td  align="left" colspan="3">&nbsp;<input name="sl_prodname" class="inputtext" type="text" id="sl_prodname" size="60" value=""><font color="red"><span id="fr_namespan"></span></font></td>
</tr>
<tr onMouseOver="this.bgColor='#E4EDF9';" onMouseOut="this.bgColor='#FFFFFF';" bgcolor="#ffffff">
<td align="right"><strong>广告宣传图:</strong></td>
<td>&nbsp;<input type="text" size="60" name="sl_bigimg" id="sl_bigimg" class="inputtext" value="" />&nbsp;<input name="button" type="button" class="uploadimg"  value="上传图片" attrname="sl_bigimg" />&nbsp;<span style="color:gray">产品图大小为：703*258px</span></td>   
</tr>
<tr onMouseOver="this.bgColor='#E4EDF9';" onMouseOut="this.bgColor='#FFFFFF';" bgcolor="#ffffff">
<td align="right"><strong>广告产品图:</strong></td>
<td>&nbsp;<input type="text" size="60" name="sl_smaimg" id="sl_smaimg" class="inputtext" value="" />&nbsp;<input name="button" type="button" class="uploadimg"  value="上传图片" attrname="sl_smaimg" /> &nbsp;<span style="color:gray">产品图大小为：213*152px</span></td>   
</tr>
<tr onMouseOver="this.bgColor='#E4EDF9';" onMouseOut="this.bgColor='#FFFFFF';" bgcolor="#ffffff">
<td align="right"><strong>链接地址:</strong></td>
<td>&nbsp;<input type="text" size="40" name="sl_linkurl" id="sl_linkurl" class="inputtext" value="" /></td>   
</tr>
<tr onMouseOver="this.bgColor='#E4EDF9';" onMouseOut="this.bgColor='#FFFFFF';" bgcolor="#ffffff">
<td align="right"><strong>到货时间:</strong></td>
<td>&nbsp;<input type="text" size="40" name="sl_gettime" id="sl_gettime" class="inputtext" value="" /></td>   
</tr>
<tr onMouseOver="this.bgColor='#E4EDF9';" onMouseOut="this.bgColor='#FFFFFF';" bgcolor="#ffffff">
<td align="right"><strong>图片排序:</strong></td>
<td>&nbsp;<input type="text" size="6" name="sl_sort" id="sl_sort" class="inputtext" value="" />&nbsp;&nbsp;<span style="color:gray">请输入一个数字，排序从小到大!</span></td>   
</tr>
<tr onMouseOver="this.bgColor='#E4EDF9';" onMouseOut="this.bgColor='#FFFFFF';" bgcolor="#ffffff">
<td  align="right">&nbsp;</td>
