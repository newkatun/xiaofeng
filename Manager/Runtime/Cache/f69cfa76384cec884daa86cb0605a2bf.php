...
<tr> <td    class="nzcms_table_top" >网站管理员列表<span class="table_spanadd"><a href="__APP__/Userlist/addtable">增加网站管理员</a></span></td></tr>
<tr valign="top">
<td  bgcolor="#FFFFFF">
...
<td  style="padding-left:8px;">
 ...
 <td align="left" valign="top" bgcolor="#FFFFFF" class="z">
  ...
  <form action="__APP__/Userlist/dellist" method="post" name="formlist" id="formlist">
  ...
  <td width="10%" class="nzcms_table_top2">修改</td>
	...
	<?php if(is_array($UserList) == true): if(is_array($UserList)): $i = 0; $__LIST__ = $UserList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$User): $mod = ($i % 2 );++$i;?><tr onMouseOver="this.bgColor='#E4EDF9';" onMouseOut="this.bgColor='#FFFFFF';" bgcolor="#ffffff">
	...
	<td align='center'><a href="__APP__/Userlist/edittable/id/<?php echo ($User["autoid"]); ?>">修改</a></td>
