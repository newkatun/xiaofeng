...
<table width="100%" border="1" cellpadding="0" cellspacing="1"  >
  <tr>
    <td    class="table_top" >产品类型列表<span class="table_spanadd"><a href="/Phone/index.php/Manager/Category/addtable">增加产品类型</a></span></td>
  </tr>
  <tr valign="top">
    <td  ><table width="100%" border="1" cellpadding="0" cellspacing="1" class="table_search" align="center">
        <tr class="search">
          <td  ><form name="formselect" method="get" action="?action=select" id="formselect">
              <strong>产品类型细类：</strong> &nbsp;
  ...
  <tr >
    <td ><table width="100%" border="1" cellpadding="0" cellspacing="1" class="table_cont">
        ...
        <?php if(isset($CategoryList) == true): ?><form action="/Phone/index.php/Manager/Category/dellist" method="post" name="formlist" id="formlist">
            <?php if(is_array($CategoryList)): foreach($CategoryList as $key=>$Cate): ?><tr class="table_trcont">
                ...
                <td >&nbsp;<a href="/Phone/index.php/manager/Productlist/index/mid/<?php echo ($Cate["autoid"]); ?>"><?php echo ($Cate["ty_name"]); ?></td>
                <td align='center'><?php echo (ProdStatus($Cate["ty_index"])); ?></td>
                <td align='center'><?php echo ($Cate["ty_sort"]); ?></td>
                <td align='center'><a href="/Phone/index.php/manager/Productlist/index/mid/<?php echo ($Cate["autoid"]); ?>">查看产品</a>&nbsp;|&nbsp;<a href="/Phone/index.php/Manager/Category/submenu/id/<?php echo ($Cate["autoid"]); ?>">查看子目录</a>&nbsp;|&nbsp;<a href="/Phone/index.php/Manager/Category/edittable/id/<?php echo ($Cate["autoid"]); ?>">修改</a></td>
          ...
          <?php if(isset($PageContent) == true): ?><tr>
              <td height="30" colspan="5" ><table border="0" align="center" width="100%" class="pagetable" >
          ...
          <?php else: ?>
          <tr>
            <td height="30" colspan="4" >没有找到相关内容！</td>
          </tr><?php endif; ?>
      </table></td>
  </tr>
</table>
