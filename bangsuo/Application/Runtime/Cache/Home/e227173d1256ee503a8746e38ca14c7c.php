...
<div class="center">
	...
	<section data-title="content" >
		<div class="content ">
			<div class="list-cont">
				<?php if(is_array($ArticleList)): foreach($ArticleList as $key=>$Case): if(($key % 3) == 1): ?><div class="img-table img-middle">
					<?php else: ?>
					<div class="img-table"><?php endif; ?>
					<div class="case-t-item">
						<div class="case-item-img"><a href="/Company/home/content/index/id/<?php echo ($Case["autoid"]); ?>" title="<?php echo ($Case["news_name"]); ?>"><img src="<?php echo ($Case["news_image"]); ?>" alt="<?php echo ($Case["news_name"]); ?>"/></a></div>
						<h2 class="case-item-name"><a href="/Company/home/content/index/id/<?php echo ($Case["autoid"]); ?>" title="<?php echo ($Case["news_name"]); ?>"><?php echo ($Case["news_name"]); ?></a></h2>
						<div class="case-item-text"><?php echo ($Case["description"]); ?></div>
					</div>
