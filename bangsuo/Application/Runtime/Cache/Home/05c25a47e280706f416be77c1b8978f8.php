...
<div class="center">
	<h1 class="page-name content"><?php echo ($Page['TypeData']['type_name']); ?><span class="page-en"><?php echo ($Page['TypeData']['type_subname']); ?></span></h1>
	<h3 class="page-subname content">高飞,衡阳网站建设领跑者,高端网站制作品牌服务商<span class="href-list"><a href="/Company">首页</a>&gt;&gt;<a href="/Company/home/artlist"><?php echo ($Page['TypeData']['MainData']['c_name']); ?></a>&gt;&gt;<a href="/Company/home/artlist/index/rurl/<?php echo ($Page['TypeData']['type_pagename']); ?>"><?php echo ($Page['TypeData']['type_name']); ?></a></span></h3>
	

		<div class="content ">
			<div class="cl mg-t"></div>
			<article>
			<div class="news-cont-section ">
				<h1 class="news-cont-title"><?php echo ($Page["news_name"]); ?></h1>
				<div class="news-cont-info ">
				<span class="datetime">发布日期：<?php echo ($Page["datetimes"]); ?></span><span class="source">来源：<?php echo ($Page["news_source"]); ?></span><span>点击次数：来源：<?php echo ($Page["news_hits"]); ?></span><span>share</span> </div>
				<div class="content-view <?php echo ($Page['TypeData']['type_pagename']); ?>-info">
				 <?php echo (htmlspecialchars_decode($Page["news_content"])); ?>
				</div>
				<div class="cl"></div>
				<div class="news-like mg-t"><span class="like">喜欢</span><span class="unlike">不喜欢</span></div>
				<div class="news-prev-next cl mg-t"><ul>
				<?php if(empty($Page['pagePrev']) == false): ?><li>上一篇：<a href="/Company/home/content/index/id/<?php echo ($Page['pagePrev'][0]['autoid']); ?>"><?php echo ($Page['pagePrev'][0]['news_name']); ?></a></li><?php endif; ?>
				<?php if(empty($Page['pageNext']) == false): ?><li>下一篇：<a href="<?php echo ($Page['pageNext'][0]['autoid']); ?>"><?php echo ($Page['pageNext'][0]['news_name']); ?></a></li><?php endif; ?>
				</ul></div>
			</div>
			</article>
			<aside>
				<div class="aside">
					<ul>
						<li class="aside-title">相关内容</li>
						<?php if(is_array($Page['TypeList'])): foreach($Page['TypeList'] as $key=>$Type): ?><li><a href="/Company/home/content/index/id/<?php echo ($Type["autoid"]); ?>" title="<?php echo ($Type["news_name"]); ?>"><?php echo ($Type["news_name"]); ?></a></li><?php endforeach; endif; ?>
					</ul>
				</div>
			</aside>
			<div class="cl"></div>
